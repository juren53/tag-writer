...
Tag Writer is a PyQt6 desktop application for viewing and editing IPTC/XMP/EXIF metadata in image files (JPG, TIFF, PNG). It uses ExifTool for metadata operations and Pillow for image handling. Current version: v0.2.4.1.
